...
export const classificationDimensions:ClassificationDimension[]=[
 ...
 ['rule','Rule-based','规则方法','規則ベース','규칙 기반'],['stat_lm','Statistical','统计方法','統計的手法','통계적 방법'],['hybrid','Hybrid','混合方法','ハイブリッド','혼합'],['neural','Neural','神经方法','ニューラル','신경망'],['llm','LLM','大语言模型','大規模言語モデル','대규모 언어 모델'],['na','NA','不适用','該当なし','해당 없음']])},
